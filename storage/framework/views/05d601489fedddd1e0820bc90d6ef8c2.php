...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Detail Pemesanan #<?php echo e($booking->id); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-6xl mx-auto pb-12">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
            <a href="<?php echo e(route('backend.booking.index')); ?>" class="inline-flex items-center gap-2 text-brown-400 hover:text-gold-400 transition-colors text-xs font-semibold tracking-[0.15em] uppercase px-4 py-2 border border-brown-800/40 rounded-full bg-dark-100/50 hover:bg-dark-200">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('backend.booking.edit', $booking)); ?>" class="inline-flex items-center gap-2 text-gold-500 hover:text-gold-400 transition-colors text-xs font-semibold tracking-[0.15em] uppercase px-4 py-2 border border-gold-500/40 rounded-full bg-gold-500/10 hover:bg-gold-500/20 shadow-lg shadow-black/20">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="inline-block px-4 py-1.5 text-[11px] font-bold uppercase tracking-[0.2em] border rounded-full <?php echo e($currentStatusColor); ?> shadow-lg shadow-black/20">
                    <?php echo e($status); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-dark-100 border border-brown-800/40 rounded-2xl p-8 relative overflow-hidden group shadow-xl shadow-black/10 transition-all hover:border-gold-500/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 rounded-full border border-gold-500/30 overflow-hidden bg-dark-200 flex items-center justify-center shrink-0">
                                    <?php if(optional($booking->user)->foto): ?>
                                        <img src="<?php echo e(asset('storage/' . $booking->user->foto)); ?>" class="w-full h-full object-cover">
                                    <?php else: ?>
                                        <span class="text-gold-500 text-sm font-bold"><?php echo e(strtoupper(substr($booking->nama_lengkap ?? optional($booking->user)->nama ?? 'U', 0, 1))); ?></span>
                                    <?php endif; ?>
                                </div>
                                <p class="text-brown-100 font-medium text-lg"><?php echo e($booking->nama_lengkap ?? optional($booking->user)->nama ?? '-'); ?></p>
                            </div>
                        </div>
                        <div>
                            ...
                            <p class="text-brown-100 font-medium text-lg flex items-center gap-2">
                                <?php echo e($booking->no_whatsapp ?? $booking->user->telepon ?? '-'); ?>

                                <?php if($booking->no_whatsapp): ?>
                                    <?php
                                    ...
                                    ?>
                                    <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', $booking->no_whatsapp)); ?>?text=<?php echo e($waTextEncoded); ?>" target="_blank" class="text-green-500 hover:text-green-400" title="Chat via WhatsApp">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-brown-200"><?php echo e($booking->user->email ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-dark-100 border border-brown-800/40 rounded-2xl p-8 shadow-xl shadow-black/10 transition-all hover:border-gold-500/20">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        <div class="sm:col-span-2 md:col-span-1 bg-dark-200/40 p-4 rounded-xl border border-brown-800/20">
                            ...
                            <p class="text-brown-100 font-medium text-lg"><?php echo e($booking->jenis_acara ?? optional($booking->acara)->nama ?? '-'); ?></p>
                        </div>
                        <div class="bg-dark-200/40 p-4 rounded-xl border border-brown-800/20">
                            ...
                            <p class="text-brown-100 font-medium text-lg"><?php echo e($booking->tanggal->format('d F Y')); ?></p>
                        </div>
                        <div class="bg-dark-200/40 p-4 rounded-xl border border-brown-800/20">
                            <span class="block text-[10px] uppercase tracking-widest text-gold-500 mb-1">Waktu Pelaksanaan</span>
                            <p class="text-brown-100 font-medium text-lg"><?php echo e($booking->waktu ?? ($booking->acara_mulai . ' - ' . $booking->acara_selesai)); ?></p>
                        </div>
                        
                        <div class="bg-dark-200/40 p-4 rounded-xl border border-brown-800/20">
                            <span class="block text-[10px] uppercase tracking-widest text-gold-500 mb-1">Jumlah Tamu (Target)</span>
                            <p class="text-brown-100 font-medium text-lg"><?php echo e($booking->jumlah_tamu ?? $booking->jumlah_porsi ?? '-'); ?> <span class="text-xs text-brown-400 font-normal">Paks</span></p>
                        </div>
                        
                        <?php if($booking->biaya_venue): ?>
                        <div class="md:col-span-2 bg-dark-200/40 p-4 rounded-xl border border-brown-800/20">
                            ...
                            <p class="text-brown-200 font-mono text-sm leading-6 tracking-wide">Rp <?php echo e(number_format($booking->biaya_venue, 0, ',', '.')); ?></p>
                        </div>
                        <?php else: ?>
                        <div class="md:col-span-2 bg-dark-200/40 p-4 rounded-xl border border-brown-800/20">
                            <span class="block text-[10px] uppercase tracking-widest text-brown-500 mb-1">Kategori Tradisional</span>
                            <p class="text-brown-200 text-sm leading-6"><?php echo e(optional(optional($booking->acara)->kategori)->nama ?? 'Layanan Fleksibel'); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if($booking->catatan): ?>
                        <div class="mt-6 bg-yellow-900/10 border-l-4 border-yellow-600/50 p-4 rounded-r-lg">
                            ...
                            <p class="text-brown-200 italic leading-relaxed text-sm">"<?php echo e($booking->catatan); ?>"</p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-dark-100 border border-brown-800/40 rounded-2xl p-8 shadow-xl shadow-black/10 transition-all hover:border-gold-500/20">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-dark-200/30 rounded-xl border border-brown-800/40 overflow-hidden">
                            ...
                            <?php if(isset($booking->layanans) && $booking->layanans->count() > 0): ?>
                                        ...
                                        <li class="flex justify-between items-center p-5 hover:bg-dark-200/50 transition-colors group">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="text-brown-100 flex items-center gap-2">
                                                    <?php echo e($lay->acara->nama ?? 'Layanan Terarsip'); ?>
                                                    ...
                                                    <?php if($lay->qty > 1 || optional(optional($lay->acara)->kategori)->nama == 'Catering' || optional(optional($lay->acara)->kategori)->nama == 'Buku Undangan'): ?>
                                                        <span class="bg-dark-300 text-[10px] px-2 py-0.5 rounded-full text-brown-400">× <?php echo e($lay->qty); ?> <?php echo e(optional(optional($lay->acara)->kategori)->nama == 'Catering' ? 'Paks' : 'Item'); ?></span>
                                                    <?php endif; ?>
                                                </span>
                                            </div>
                                            <span class="text-brown-300 font-mono text-sm">Rp <?php echo e(number_format($lay->harga, 0, ',', '.')); ?></span>
                                        </li>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                ?>
                <div class="bg-gradient-to-br from-dark-100 to-[#1e1915] border <?php echo e($boxBorderClass); ?> rounded-2xl p-8 relative overflow-hidden text-center transform transition-transform hover:-translate-y-1 duration-500">
                    ...
                    <div class="text-3xl sm:text-4xl font-serif text-gold-400 mb-6 font-normal drop-shadow-sm relative z-10"><?php echo e($booking->formatted_subtotal); ?></div>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-6 relative z-10">
                        <div class="bg-yellow-900/20 border border-yellow-700/30 rounded-xl p-3 flex flex-col justify-center">
                            ...
                            <span class="text-[15px] font-mono text-yellow-400 font-bold">Rp <?php echo e(number_format($booking->subtotal * 0.3, 0, ',', '.')); ?></span>
                        </div>
                        <div class="bg-red-900/20 border border-red-700/30 rounded-xl p-3 flex flex-col justify-center">
                            ...
                            <span class="text-[15px] font-mono text-red-400 font-bold">Rp <?php echo e(number_format($booking->subtotal * 0.7, 0, ',', '.')); ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="pt-6 border-t border-gold-800/40 text-left relative z-10">
                        ...
                        <div class="font-bold tracking-wider text-gold-100 bg-dark/60 p-4 rounded-xl border border-gold-900/40 text-xs flex items-center justify-center gap-2 shadow-inner">
                            ...
                            <?php echo e(str_replace('_', ' ', strtoupper($booking->metode_pembayaran ?? 'BELUM DIATUR'))); ?> 
                            <?php if($booking->bank): ?>
                            <span class="text-brown-400 font-normal mx-1">—</span> <?php echo e(strtoupper($booking->bank)); ?>
                ...
                <div class="bg-dark-100 border border-brown-800/40 rounded-2xl p-7 shadow-xl shadow-black/10">
                    ...
                    <form method="POST" action="<?php echo e(route('backend.booking.updateStatus', $booking)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6 relative">
                            ...
                            <div class="relative">
                                <select name="status" class="w-full bg-dark-200 border border-brown-700/60 text-brown-100 rounded-xl focus:ring-gold-500 focus:border-gold-500 py-3.5 pl-4 pr-10 text-sm font-medium appearance-none cursor-pointer hover:border-brown-600 transition-colors shadow-inner" required>
                                    <option value="pending" <?php echo e($status == 'pending' ? 'selected' : ''); ?> class="bg-dark text-yellow-500 py-2">⏳ PENDING</option>
                                    <option value="di booking" <?php echo e($status == 'di booking' ? 'selected' : ''); ?> class="bg-dark text-blue-400 py-2">📝 DI BOOKING</option>
                                    <option value="selesai" <?php echo e($status == 'selesai' ? 'selected' : ''); ?> class="bg-dark text-green-400 py-2">✅ SELESAI / LUNAS</option>
                                    <option value="batal" <?php echo e($status == 'batal' ? 'selected' : ''); ?> class="bg-dark text-red-400 py-2">❌ BATAL</option>
                                </select>
                    ...
                    <div class="mt-8 pt-5 border-t border-brown-800/30 grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <span class="text-xs text-brown-300"><?php echo e($booking->created_at->format('d M y, H:i')); ?></span>
                        </div>
                        <div>
                            <span class="block text-[9px] uppercase tracking-widest text-[#6b5e4f] mb-1 font-bold">Terakhir Update</span>
                            <span class="text-xs text-brown-300"><?php echo e($booking->updated_at->format('d M y, H:i')); ?></span>
                        </div>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\0704\2505\wedding-organizer\resources\views/backend/booking/show.blade.php ENDPATH**/ ?>