...
<head>
    ...
    <title><?php echo e($title ?? 'MELODI - Masuk'); ?></title>
...
<div class="auth-card">
    ...
    <div class="left-panel">
        ...
        <a href="<?php echo e(route('home')); ?>" class="left-logo">M E L O D I</a>
        <div class="left-divider"></div>

        
        <div class="auth-tabs">
            <button class="auth-tab <?php echo e($activeForm === 'login' ? 'active' : ''); ?>"
                    onclick="switchForm('login')" id="tabLogin">
                <div class="tab-dot"></div>
                <span>Masuk</span>
            </button>

            <button class="auth-tab <?php echo e($activeForm === 'register' ? 'active' : ''); ?>"
    ...
    <div class="right-panel">
        <div class="slides-track">
            ...
            <div class="form-slide <?php echo e($activeForm === 'login' ? 'state-current' : 'state-below'); ?>" id="slideLogin">
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="ferror"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="frow">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="flink">Lupa password?</a>
                        <?php endif; ?>
                    </div>
            ...
            <div class="form-slide <?php echo e($activeForm === 'register' ? 'state-current' : 'state-below'); ?>" id="slideRegister">
...
<script>
var currentForm = '<?php echo e($activeForm); ?>';
...
<?php /**PATH C:\0704\2505\wedding-organizer\resources\views/layouts/guest.blade.php ENDPATH**/ ?>