...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Edit Kategori <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-lg">
        ...
        <div class="bg-dark-100 border border-brown-800/30 rounded-xl p-6">
            ...
            <form method="POST" action="<?php echo e(route('backend.kategori.update', $kategori)); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="mb-6">
                    <label class="label-melodi">Tipe Layanan</label>
                    <input type="text" name="tipe" class="input-melodi" value="<?php echo e(old('tipe', $kategori->tipe)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama" class="input-melodi" value="<?php echo e(old('nama', $kategori->nama)); ?>" required>
...
<?php endif; ?>
<?php /**PATH C:\0704\1304\wedding-organizer\resources\views/backend/kategori/edit.blade.php ENDPATH**/ ?>