...
<div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <div>
            ...
            <input type="number" name="jumlah_tamu" x-model="jumlahTamu" placeholder="Max. 1500 Tamu"
                   class="w-full bg-[#2e261f] border border-[#5d5248] text-[#f5f0e8] px-3 py-2 text-[13px] font-medium outline-none focus:border-[#c9a84c] transition-colors rounded-none placeholder:text-[#a89880]/50">
        </div>
    </div>
...
<?php /**PATH C:\0704\1304\wedding-organizer\resources\views/frontend/partials/order-step1.blade.php ENDPATH**/ ?>