    ...
    <div class="fixed inset-0 z-10 flex items-center justify-center p-4 md:p-6">
        ...
        <div x-show="step === 4" 
            ...
            <div class="px-4 py-5 md:px-6 overflow-y-auto" style="scrollbar-width: thin;">
                ...
                {{-- Data Pemesan Card (Dikasih Border & Padding) --}}
                ...
                {{-- Detail Layanan Card (Border & Padding) --}}
            ...
            {{-- Total Bottom Block (Sticky) --}}
            <div class="bg-dark-200 border-t border-brown-700/50 shrink-0">
                
                {{-- Pembayaran & Total Bar --}}
                <div class="px-5 py-4 lg:px-6 lg:py-5 border-b border-brown-700/30">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="text-right">
                            ...
                            <span :class="metodePembayaran === 'dp_30' ? 'text-lg font-serif text-brown-200' : 'text-2xl font-serif text-gold-400 font-bold tracking-wide'" x-text="formatRupiah(grandTotal) || '-'"></span>
                        </div>
                    </div>

                    <template x-if="metodePembayaran === 'dp_30'">
                        <div class="mt-3 pt-3 border-t border-brown-700/30 flex justify-between items-end">
                            <div>
                                <span class="block text-red-400/80 text-[9px] italic uppercase tracking-widest mb-0.5">Kekurangan Pembayaran</span>
                                <span class="text-sm font-mono text-red-400/90 font-bold tracking-wide" x-text="formatRupiah(grandTotal * 0.7) || '-'"></span>
                            </div>
                            <div class="text-right">
                                <span class="block text-gold-500 text-[10px] font-bold uppercase tracking-widest mb-0.5">Wajib Dibayar (DP 30%)</span>
                                <span class="text-2xl font-serif text-gold-400 font-bold tracking-wide" x-text="formatRupiah(grandTotal * 0.3) || '-'"></span>
                            </div>
                        </div>
                    </template>
                </div>

                {{-- Action Buttons (Grid Layout ensures exactly no overlap) --}}
