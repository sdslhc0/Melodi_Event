    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 lg:ml-64">
            ...
            <header class="h-20 bg-dark-100/80 backdrop-blur-md border-b border-brown-800/30 flex items-center justify-between px-6 sticky top-0 z-30">
                ...
                <div class="flex items-center gap-4">
                    <span class="text-sm text-brown-400"><?php echo e(Auth::user()->nama); ?></span>
...
<?php /**PATH C:\0704\1304\wedding-organizer\resources\views/layouts/backend.blade.php ENDPATH**/ ?>