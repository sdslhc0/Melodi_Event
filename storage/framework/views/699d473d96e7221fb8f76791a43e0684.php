    ...
    <div class="max-w-6xl mx-auto pb-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-gradient-to-br from-dark-100 to-[#1e1915] border border-gold-500/30 rounded-2xl p-8 relative overflow-hidden text-center shadow-[0_10px_40px_rgba(201,168,76,0.06)] transform transition-transform hover:-translate-y-1 duration-500">
                    ...
                    <div class="text-3xl sm:text-4xl font-serif text-gold-400 mb-8 font-normal drop-shadow-sm relative z-10"><?php echo e($booking->formatted_subtotal); ?></div>
...
<?php endif; ?>
<?php /**PATH C:\0704\1304\wedding-organizer\resources\views/backend/booking/show.blade.php ENDPATH**/ ?>