...
<?php $component->withAttributes([]); ?>
    ...
    <div class="lg:col-span-1 p-6 bg-dark-100 border border-brown-800/30 rounded-xl overflow-hidden flex flex-col"
         x-data='{
             pieData: <?php echo json_encode(isset($pieData) ? $pieData : [], 15, 512) ?>,
             pieChart: null,
             initPieChart() {
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'export-modal','maxWidth' => 'md','focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'export-modal','maxWidth' => 'md','focusable' => true]); ?>
        <form method="POST" action="<?php echo e(route('backend.export')); ?>" class="p-6 bg-dark-100">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\0704\2505\wedding-organizer\resources\views/backend/dashboard.blade.php ENDPATH**/ ?>