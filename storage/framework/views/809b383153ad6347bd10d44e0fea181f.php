...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Tambah Acara <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-dark-100 border border-brown-800/30 rounded-xl p-6">
            ...
            <form method="POST" action="<?php echo e(route('backend.acara.store')); ?>" enctype="multipart/form-data" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select name="id_kategori" class="select-melodi" required>
                        ...
                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kat->id); ?>" <?php echo e(old('id_kategori') == $kat->id ? 'selected' : ''); ?>><?php echo e($kat->nama); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="nama" class="input-melodi" value="<?php echo e(old('nama')); ?>" required placeholder="Contoh: Paket Pernikahan Elegant">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="harga" class="input-melodi" value="<?php echo e(old('harga')); ?>" required min="0" placeholder="25000000">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="5" class="input-melodi resize-none" placeholder="Deskripsi paket acara..."><?php echo e(old('deskripsi')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\0704\1304\wedding-organizer\resources\views/backend/acara/create.blade.php ENDPATH**/ ?>